<template>
    <div class="modal fade" id="add-book-modal" tabindex="-1" role="dialog" aria-labelledby="add-book-modal-label" aria-hidden="true" ref="createAndEditFaqModalRef">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-book-modal-label">Add book</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" method="POST"  @submit.prevent="storeBook" enctype="multipart/form-data">
                        ...
                        <div class="form-group mx-2 my-2">
                            ...
                            <div>
                                <img class="rounded"
                                     ...
                                     alt="Cover image"
                                     :src="loadImage"
                                     v-if="checkIfNotEmpty(loadImage)">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary submit-btn">
                            Add
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" v-show="storing"></span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            storeBook() {
                ...
                const inputFieldsArray = ['title', 'description', 'genre_id', 'author_id'];
        ...
        mounted() {
            this.loadData();
            EventBus.$on('open-add-book-modal', () => this.addBook());
